...
def s_b():
    ...
    if a!='':
        ...
        messagebox.showinfo('Search Field Empty', 'Nothing to Search \n Search a valid Keyword')
...
def save_into_pc():
    save()
def c_f_update():
    site_update='https://docs.google.com/document/d/1lqBnBOjymfqE1Q13Nc6JPgeoNyYYF9JO7K7LP1v8yuI/edit?usp=sharing'
    webbrowser.open(site_update)
#   Menu Design
mm=Menu(root)
...
search_button=Button(f,image=file_s,command=s_b,borderwidth=4)
...
search_button=Button(f,image=file_m,command=speech,borderwidth=4)
